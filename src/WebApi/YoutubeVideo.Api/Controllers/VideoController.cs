...
public class VideoController : ControllerBase
{
    ...
    [HttpGet("filter")]
    public async Task<IActionResult> FilterVideos([FromQuery] VideoFilterDto filterDto)
    {
    ...
    [HttpPut("{id}")]
    public async Task<IActionResult> UpdateVideo(string id, [FromBody] VideoDto video)
    {
        if (id == string.Empty)
        {
